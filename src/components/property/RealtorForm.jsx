      ...
      <div className="w-full border border-solid border-[#e0e0e0] border-t-0 rounded-[14px] overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 pb-4">
          <div className="flex flex-col gap-2.5">
            ...
            <Input
              className="h-12 px-4 rounded-xl border border-solid border-[#e0e0e0]"
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="flex h-12 items-center justify-center gap-2.5 px-4 py-0 bg-[#f6f6f6] rounded-xl border border-dashed border-[#e0e0e0]">
